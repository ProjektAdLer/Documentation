...
function parseCsUnitTests(reqIds, unitTestFolder, unitTestEnding, expectedFileExtention) {
    return __awaiter(this, void 0, void 0, function* () {
        // Find all test Folders of the Sub Projects
        const unitTestFolders = yield fsPromises.readdir(unitTestFolder);
        const filteredUnitTestFolders = unitTestFolders.filter((folder) => folder.endsWith(unitTestEnding));
        const csFilesPromises = filteredUnitTestFolders.map((folder) => findCsFiles(path.join(unitTestFolder, folder), expectedFileExtention));
        const potentialTestFiles = flattenArray(yield Promise.all(csFilesPromises));
...
function findCsFiles(dir, expectedFileExtention) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const files = entries.map((entry) => __awaiter(this, void 0, void 0, function* () {
            ...
            return entry.isDirectory()
                ? findCsFiles(fullPath, expectedFileExtention)
