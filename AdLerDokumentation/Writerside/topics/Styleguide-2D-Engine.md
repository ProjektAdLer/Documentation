...
# AdLer-Engine Design Guideline

Auf dieser Seite werden alle getroffenen Überlegungen zum Design der AdLer Engine selbst und deren User Interface (UI) zusammengefasst dargestellt und gesammelt.
